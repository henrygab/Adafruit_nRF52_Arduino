...
#define WIRING_CONFLICT_USE_INLINE 1


#if WIRING_CONFLICT_USE_INLINE
  #define WIRING_CONFLICT_INLINE               inline __attribute__((always_inline))
  #define WIRING_CONFLICT_STATIC_INLINE static inline __attribute__((always_inline))
#else
  #define WIRING_CONFLICT_INLINE               inline __attribute__((noinline))
